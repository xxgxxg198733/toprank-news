...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/free-ai-tools`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/alternatives`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/ai-tools-directory`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/best-ai-writing-tools-2026`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/blog/ai-data-analysis-guide-2026`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
  ];
}
